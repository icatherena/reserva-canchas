...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .and()
            .authorizeHttpRequests().antMatchers("/alquileres","/alquileres/crear", "/alquileres/editar/*", "/alquileres/ver", "/complejosdeportivos", "/complejosdeportivos/ver", "/complejosdeportivos/editar/*", "/deportes", "/deportes/ver", "/deportes/editar/*", "/canchas", "/canchas/ver", "/canchas/editar/*", "/roles", "/roles/ver", "/roles/editar/*")
